...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            ...
            nn.BatchNorm2d(8),
            nn.Dropout(0.05),
            nn.Conv2d(8, 16, 3), # Convolution Layer 2 - input 28 x 28 x 8 : Output 26 x 26 x 16 : RF 5 x 5
            nn.ReLU(), 
            nn.BatchNorm2d(16), 
            nn.Dropout(0.05),  
            nn.MaxPool2d(2, 2) # Max Pooling Layer - input 26 x 26 x 16 : Output 13 x 13 x 16 : RF 10 x 10
        )
        self.conv2 = nn.Sequential(
            nn.Conv2d(16, 8, 1), # Convolution Layer 3 - input 13 x 13 x 16 : Output 13 x 13 x 8 : RF 12 x 12
            nn.ReLU(),
            nn.BatchNorm2d(8),
            nn.Dropout(0.05),
            nn.Conv2d(8, 16, 3), # Convolution Layer 4 - input 13 x 13 x 8 : Output 11 x 11 x 16 : RF 14 x 14
            nn.ReLU(),
            nn.BatchNorm2d(16),
            nn.Dropout(0.05),
            nn.Conv2d(16, 32, 3), # Convolution Layer 5 - input 11 x 11 x 16 : Output 9 x 9 x 32 : RF 16 x 16
            nn.ReLU(),
            nn.BatchNorm2d(32),
            nn.Dropout(0.05),
            nn.Conv2d(32, 32, 3), # Convolution Layer 6 - input 9 x 9 x 32 : Output 7 x 7 x 32 : RF 18 x 18
            nn.ReLU(),
            nn.BatchNorm2d(32),
            nn.Dropout(0.05),
        )
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(32, 10, 3), # Convolution Layer 7 - input 7 x 7 x 32 : Output 5 x 5 x 10 : RF 20 x 20
            nn.ReLU(),
            nn.BatchNorm2d(10),
            nn.Dropout(0.05),
            nn.AvgPool2d(5) # Average Pooling Layer - to reduce the dimensions to 1
        )
